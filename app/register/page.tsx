...
import { Disc3, Eye, EyeOff, Check } from "lucide-react"
        ...
        <div className="max-w-md">
          ...
          <div className="mt-12 p-6 bg-secondary rounded-xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <p className="font-semibold text-foreground">Jake Morrison</p>
                <p className="text-sm text-muted-foreground">EDM Producer</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {artistTypes.map((type) => (
                  <button
                    key={type.id}
                    type="button"
                    onClick={() => setFormData({ ...formData, artistType: type.id })}
                    className={`p-3 rounded-lg border text-sm font-medium transition-colors ${
                      formData.artistType === type.id
