    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex flex-1 bg-card items-center justify-center p-8">
        <div className="max-w-md text-center">
          <div className="w-64 h-64 mx-auto mb-8 bg-secondary rounded-xl flex items-center justify-center">
            <div className="flex items-end gap-2 h-32">
              {[60, 80, 45, 90, 55, 75, 40, 85, 65, 70].map((height, i) => (
                <div
                  key={i}
                  className="w-4 bg-primary rounded-t animate-pulse"
                  style={{ 
                    height: `${height}%`,
