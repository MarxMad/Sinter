      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground">
            Genera cualquier género
          </h2>
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Del Hip-Hop al Ambient, nuestra IA entiende los matices de cada estilo.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {genres.map((genre, index) => (
            <div
              key={index}
              className="p-6 bg-card/80 rounded-xl border border-border hover:border-primary/50 transition-colors duration-200 cursor-pointer"
            >
