        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="#pricing" className="text-muted-foreground hover:text-foreground">Precios</Link></li>
              <li><Link href="#genres" className="text-muted-foreground hover:text-foreground">Géneros</Link></li>
              <li><Link href="/studio" className="text-muted-foreground hover:text-foreground">Estudio</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="#" className="text-muted-foreground hover:text-foreground">Nosotros</Link></li>
              <li><Link href="#" className="text-muted-foreground hover:text-foreground">Blog</Link></li>
              <li><Link href="#" className="text-muted-foreground hover:text-foreground">Carreras</Link></li>
